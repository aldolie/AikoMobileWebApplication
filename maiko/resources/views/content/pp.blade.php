...
@section('content')
<div class="container" ng-controller="ProductPOController">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 row-app" ng-repeat="product in products">
			...
			<div class="col-md-8 col-sm-8 col-xs-9">
				...
				<div>
					...
					<a href="{{url('Product')}}/[[product.productid]]/[[clean(product.productname)]]" class="btn btn-primary btn-view">View</a>
				</div>
				<div>
